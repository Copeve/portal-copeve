	...
	return (
		<main className="flex flex-col gap-16">
			...
			<Section
				title="Visão"
				text={
					'A Comissão Permanente do Vestibular (Copeve) constitui, no âmbito da UFMG, uma instância apta a atender, com presteza, competência e segurança às necessidades de realização de Concursos Públicos municipais, estaduais e federais.'
				}
			/>
